...
const MenuSwipe = ({onSelect}: Props) => {
    ...
    return(
        <div className="fixed mx-auto left-0 right-0 bottom-[32px] w-[608px] h-[88px] bg-white rounded-[32px] flex p-[8px] gap-[8px]">
            <div className={`w-[292px] h-[72px] rounded-[24px] bg-accent absolute z-0 transition duration-300 ${currOption === 1 && "translate-x-[300px]"}`}/>
            <div 
                onClick = {() => {
                    setCurrOption(0);
                    onSelect(0);
