...
const UserTableCell = ({
  ...
  return (
    <div
      onClick={onCellClick}
      className={`w-[358px] duration-200 active:min-h-full active:bg-[#004662B2] active:text-white min-h-[74px] max-h-[212px] rounded-[24px] bg-[#FFFFFFB2] p-[12px] flex gap-[8px] justify-center items-center text-accent font-semibold`}
    >
